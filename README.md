...
Milestones 1 through 4 are implemented; see the [milestone 1](docs/milestone-1-report.md), [milestone 2](docs/milestone-2-report.md), [milestone 3](docs/milestone-3-report.md), and [milestone 4](docs/milestone-4-report.md) reports for what was verified and what remains. Milestone 5 (pilot hardening) is in progress. No speech or AI provider has been called yet; run `pnpm eval:extraction` with keys before trusting extraction quality. Performance and product metrics in the roadmap are proposed acceptance targets, not measured results.
